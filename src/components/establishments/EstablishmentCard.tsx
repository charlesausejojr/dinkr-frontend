    ...
    >
      ...
      {coverImage ? (
        <div className="w-full h-40 overflow-hidden bg-gray-100 shrink-0">
          <img src={coverImage} alt={establishment.name} className="w-full h-full object-cover" />
        </div>
      ) : (
        <div className="w-full h-40 bg-gradient-to-br from-court-green/10 to-court-lime/10 flex items-center justify-center shrink-0">
